    ...
    return (
        <div className={toggleNav?'navbarContainer':'navbarContainer Close'}>
            <div className='Navbar'>
                <ul>
                    <li onClick={removeActive}><Link to="/Home"><img src="/image/home.svg" alt="Home"/></Link></li>
                    <li onClick={removeActive}><Link onClick={pinchTrue} to="/"><img src="/image/about.svg" alt="About"/></Link></li>
